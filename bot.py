...
def send_email(subject: str, html: str):
    sender    = os.environ["anilgithubd@gmail.com"]       # your Gmail
    password  = os.environ["wzvd ydla nyru ectk"]  # Gmail App Password
    recipient = os.environ["anilgithubd@gmail.com"]    # where to receive
